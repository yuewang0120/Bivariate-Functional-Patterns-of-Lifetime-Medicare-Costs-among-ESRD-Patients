...
if (type == 1) {
    ...
    data.frame(h = h, fold = fold, sse = sum(res^2, na.rm = T), nobs = sum(!is.na(res))) %>% saveRDS(paste0('real_mixed_cv1/ip_h=', h, '_fold=', fold))
} else if (type == 2) {
    ...
    data.frame(h = h, fold = fold, sse = sum(res^2, na.rm = T), nobs = sum(!is.na(res))) %>% saveRDS(paste0('real_mixed_cv1/op_h=', h, '_fold=', fold))
} else if (type == 3) {
    ...
    data.frame(h = h, fold = fold, sse = sum(res^2, na.rm = T), nobs = sum(!is.na(res))) %>% saveRDS(paste0('real_mixed_cv1/sn_h=', h, '_fold=', fold))
} else if (type == 4) {
    ...
    data.frame(h = h, fold = fold, sse = sum(res^2, na.rm = T), nobs = sum(!is.na(res))) %>% saveRDS(paste0('real_mixed_cv1/hh_h=', h, '_fold=', fold))
} else if (type == 5) {
    ...
    data.frame(h = h, fold = fold, sse = sum(res^2, na.rm = T), nobs = sum(!is.na(res))) %>% saveRDS(paste0('real_mixed_cv1/hs_h=', h, '_fold=', fold))
} else {
    ...
    data.frame(h = h, fold = fold, sse = sum(res^2, na.rm = T), nobs = sum(!is.na(res))) %>% saveRDS(paste0('real_mixed_cv1/all_h=', h, '_fold=', fold))
}
